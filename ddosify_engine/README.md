...
rpm -i https://github.com/getanteon/anteon/releases/latest/download/ddosify_amd64.rpm

# For Debian based (Ubuntu, Linux Mint, etc.)
wget https://github.com/getanteon/anteon/releases/latest/download/ddosify_amd64.deb
dpkg -i ddosify_amd64.deb

# For Alpine
wget https://github.com/getanteon/anteon/releases/latest/download/ddosify_amd64.apk
...
### Windows exe from the [releases page](https://github.com/getanteon/anteon/releases/latest)
